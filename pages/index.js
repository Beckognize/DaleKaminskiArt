...
<body>
   <div className = 'container-fluid'>
    <div className ='photobox'>
        ...
        <Link href='/gallery8'><a><img style={{ top: "15%", left: "22%", width: '18%' }} src='images/Hail_Badger.jpg' alt='large ship'></img></a></Link>
        <Link href='/gallery1'><a><img style={{ top: "3%", left: "10%", width: '20%' }} src='images/MainStreet_flags_america.jpg' alt='pickup truck with many american flags'></img></a></Link>
